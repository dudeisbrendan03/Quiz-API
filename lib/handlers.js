...
handlers.quiz.post = function (data, callback) {
    const   question            = typeof category === 'string' && data.payload.question.length > 2 ? data.payload.question : false,
            answers             = data.payload.answers.length = 3 && data.payload.answers.constructor === Array ? data.payload.answers : false,
            answer              = typeof answer === 'number' && (data.payload.answer >= 1 && data.payload.answer <= 3) ? data.payload.answer : false,
